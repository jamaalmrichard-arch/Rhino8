# EMAIL SEQUENCE C1 — ACTIVE INVESTOR TRACK
## Post "The Deal Machine" Purchase ($147) → $5,997 Group Coaching Application
## Identity + Value + Case Study + Pitch Sequence | 9 Emails | 18 Days
## Brand: J. Marque | Template assignments noted per email

---

## EMAIL 1 — Day 0 (Immediate after $147 purchase)
**Template: 1 (Premium Branded)**

**Subject:** You're in the deal-making track now
**Preview text:** Your Deal Machine guide + audio modules are ready.

---

{first_name},

You picked the active investor track. That tells me something about you.

You don't want to sit on the sidelines and watch. You want to make money. You want to close deals. You want to build something real.
...
**Subject:** Why I love down markets
**Preview text:** Everyone else runs. That's exactly why I show up.

---

{first_name},

When interest rates went up and the media started screaming "crash," most people ran.

Good. Let them run.

I've been doing this for 15 years. I've done deals in 2008, 2020, 2022, and right now. And I'm going to tell you something that sounds backwards:

**The best deals I've ever done were in markets that scared everyone else.**
...
**Subject:** My first deal lost me money
**Preview text:** And my second one fell apart at closing.
...
That system has now produced $250 million in transactions. Not because I'm special. Because the system is.
...
P.S. The 13-Touch Follow-Up Script Pack in your templates? That system alone has generated hundreds of thousands in assignment fees. Don't skip it.
...
**Subject:** {first_name}, meet David -- $95K engineer to $6,800/mo
**Preview text:** 12 months. Same system. Different life.
...
12 months ago, David was an engineer making $95K. Comfortable by most standards. But he had zero wealth. No assets. No cash flow outside his paycheck. A 401(k) growing at 6% in good years and getting demolished in bad ones.
...
P.S. David's biggest regret? "I wish I'd started 5 years ago." The second best time is now.
...
**Subject:** Keisha's first wholesale check was $8,500
**Preview text:** A teacher making $52K. Single mom. Zero experience.

---

{first_name},

Different person. Same system.

Keisha was a teacher making $52K. Single mom. No connections in real estate. No capital. She thought this industry was for people with trust funds and rich uncles.

She was wrong.

Keisha's timeline:

**Month 1-2:** She went through The Foundation workbook (her finances needed work first), then moved into the deal-making material. Found $680/month she was hemorrhaging on subscriptions and lifestyle creep.

**Month 3:** Closed her first wholesale deal using the scripts and the 13-touch follow-up system. Assignment fee: **$8,500.** She cried. That was 2 months of take-home pay from teaching.

**Month 4-7:** Used the wholesale money plus a hard money loan to BRRRR a distressed duplex. Purchase: $165K. Rehab: $28K. Rented both units for $2,900/month. Refinanced and pulled her capital back out.

**Month 8-11:** Two more properties. Total rental income: **$4,200/month.**
...
Are you working through the modules? Reply and tell me where you are. I read every email.
...
**Subject:** 3 mistakes that keep new investors broke
**Preview text:** Smart people make these. Don't be one of them.
...
I'm about to tell you how to get that person.
...
**Preview text:** 6 months. A system. Accountability. Your first deal.

---

{first_name},

You've had The Deal Machine for almost two weeks. You've heard my story. You've seen what David and Keisha did with the same system you're holding.

Now it's your turn to decide: are you going to study deals, or close them?
...
This is for you if:
- You've gone through The Deal Machine (or you're working through it now)
- You're ready to execute, not just learn
- You can commit to 2 calls per week for 6 months
- You want to close your first deal (or your next 10) with someone who's done $250M backing you up

If that's you, apply. Takes 3 minutes.

-- J. Marque

P.S. Everyone who applies gets a free strategy call -- whether you join the program or not. On the call, I'll map out your personalized 90-day deal plan. It's yours to keep regardless.
...
**Subject:** 7 spots left -- your questions answered
**Preview text:** The 4 questions every active investor asks before joining.
...
When the cohort fills, the next one opens in 3 months. The market isn't waiting.
...
**Preview text:** Last email about this.
...
P.S. If the timing isn't right but you want to stay on the radar, reply "later" and I'll personally notify you when the next cohort opens. No strings.

---

## SEQUENCE C1 TEMPLATE MAP

| Email | Day | Template | Type | Subject |
|-------|-----|----------|------|---------|
| 1 | 0 | Premium Branded | Welcome/Delivery | You're in the deal-making track now |
| 2 | 2 | Clean Minimal | Value (Down Markets) | Why I love down markets |
| 3 | 4 | Pure Text | Origin Story | My first deal lost me money |
| 4 | 6 | Clean Minimal | Case Study (David) | {first_name}, meet David |
| 5 | 8 | Clean Minimal | Case Study (Keisha) | Keisha's first wholesale check was $8,500 |
| 6 | 10 | Pure Text | Mistakes/Guide | 3 mistakes that keep new investors broke |
| 7 | 12 | Dark Premium | THE PITCH | Applications are open -- 15 spots |
| 8 | 15 | Clean Minimal | FAQ/Objections | 7 spots left -- your questions answered |
| 9 | 18 | Pure Text | Break-Up | closing applications friday |
...
| 2 | 40%+ | N/A | Story engagement |
| 3 | 38%+ | N/A | Origin story + trust building |
| 4 | 35%+ | N/A | Case study engagement |
| 5 | 33%+ | 3%+ | Case study + reply rate |
...
**Target:** 8-12% of Deal Machine buyers submit a coaching application.
**Price anchoring:** $5,997 vs Keisha's $8,500 first wholesale check. Program pays for itself on deal one.
