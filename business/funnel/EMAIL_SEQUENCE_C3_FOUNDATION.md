# EMAIL SEQUENCE C3 — THE FOUNDATION TRACK
## Post "The Foundation" Purchase ($97) → $5,997 Group Coaching Application
## Identity + Value + Case Study + Pitch Sequence | 9 Emails | 18 Days
## Brand: J. Marque | Template assignments noted per email

---

## EMAIL 1 — Day 0 (Immediate after $97 purchase)
**Template: 1 (Premium Branded)**

**Subject:** Welcome to The Foundation -- here's your plan
**Preview text:** You just took the hardest step. Here's what's next.

---

{first_name},

You chose The Foundation. And I want you to know something before we go any further:

Starting from scratch is not behind. It's brave.

Most people who are in your position right now do one of two things: they pretend everything is fine and keep doing what they've been doing. Or they feel so overwhelmed that they freeze and do nothing.

You just did the third thing. The rare thing. You said: "I'm going to figure this out."
...
You've already done the hard part. Let's keep going.
...
**Subject:** I started with less than you think
**Preview text:** $250M in real estate started with nothing.

---

{first_name},

People hear "$250 million in real estate" and assume I came from money.

I came from the Marines.

No trust fund. No rich parents. No connections in real estate. I came out of the service with discipline, a few thousand dollars in savings, and zero knowledge of how money actually works.

My first apartment was $600/month. My credit score was in the low 600s. I had no idea what a cap rate was, what a 1031 exchange meant, or why people were paying $200K for houses that looked like they were falling apart.

I figured it out the hard way. Mistake by mistake. Loss by loss. But I learned something that changed everything:

**Starting from zero is an advantage.**

You have no bad habits to unlearn. No bad deals to recover from. No bad advice to undo. You're a blank page. And a blank page with the right system becomes the most dangerous thing in any market.
...
Reply and tell me what you find. I read every email.
...
**Subject:** The $680/month Keisha didn't know she was wasting
**Preview text:** She was a teacher making $52K. Sound familiar?
...
A year ago, Keisha was a teacher making $52K. Single mom. She thought investing was for people with money she didn't have.
...
P.S. Keisha says Module 1 made her angry and grateful at the same time. "Angry I'd been wasting it. Grateful I finally saw it." That's the right reaction.
...
**Subject:** {first_name}, Keisha now owns 3 properties
**Preview text:** Teacher. $52K salary. Zero experience. 11 months later...

---

{first_name},

Remember Keisha? The teacher who found $680/month she was wasting?
...
**Month 6:** Rented both units. Gross rent: $2,900/month. Refinanced and pulled her capital back out.

**Month 8-11:** Repeated the process. Two more properties. Total rental income: **$4,200/month.**
...
P.S. Keisha's biggest advice? "Do Module 1 even if it scares you. Especially if it scares you."
...
**Subject:** You're not starting late -- you're starting right
**Preview text:** The most dangerous myth in personal finance.

---

{first_name},

There's a myth in personal finance that does more damage than bad advice:
...
David was 34 when he started. He's now producing $2,400/month in cash flow from 4 properties.

Keisha was 29. She went from $52K teaching salary to $4,200/month in rental income in under a year.

I was 28 when I closed my first deal. I'd been out of the Marines for two years, had no idea what I was doing, and lost money on it.

None of us started at the "right" time. We started at OUR time. And that made all the difference.

Where are you in the workbook? If you've done Modules 1-3, you're further ahead than 95% of people who say they want to build wealth. If you haven't started yet, today is your "right" time.

Reply and tell me where you are. No judgment. Just accountability.
...
**Subject:** 4 mistakes beginners make (and how to avoid every one)
**Preview text:** I made all 4. You don't have to.
...
**Preview text:** 6 months. A mentor. Your first deal.

---

{first_name},

You picked The Foundation because you were honest with yourself. You said "I'm starting from scratch, and I need to get this right."
...
I know that's a real number. So let me put it in perspective.
...
This is for you if:
- You've started The Foundation (or you're ready to start)
- You're serious about building wealth, not just thinking about it
- You can commit to 2 calls per week for 6 months
- You want a mentor, not another course

If that sounds like you, apply. It takes 3 minutes.
...
**Preview text:** Everything beginners ask before saying yes.

---

{first_name},

7 spots filled in 3 days. 8 left for this cohort.
...
**"What if I haven't finished The Foundation yet?"**
...
The next cohort is 3 months out. The best time to start was yesterday. The second best time is now.
...
**Preview text:** Then back to regular value.
...
P.S. Reply "later" and I'll personally notify you when the next cohort opens. No automation. Just me.

---

## SEQUENCE C3 TEMPLATE MAP

| Email | Day | Template | Type | Subject |
|-------|-----|----------|------|---------|
| 1 | 0 | Premium Branded | Welcome/Delivery | Welcome to The Foundation -- here's your plan |
| 2 | 2 | Clean Minimal | Origin Story | I started with less than you think |
| 3 | 4 | Clean Minimal | Case Study Intro (Keisha) | The $680/month Keisha didn't know she was wasting |
| 4 | 7 | Pure Text | Full Case Study (Keisha) | {first_name}, Keisha now owns 3 properties |
| 5 | 9 | Clean Minimal | Encouragement + Value | You're not starting late -- you're starting right |
| 6 | 11 | Pure Text | Mistakes/Guide | 4 mistakes beginners make |
| 7 | 13 | Dark Premium | THE PITCH | Applications are open -- 15 spots |
| 8 | 15 | Clean Minimal | FAQ/Objections | 8 spots left -- your questions answered |
| 9 | 18 | Pure Text | Break-Up | last email about this |

## SEQUENCE C3 METRICS

| Email | Target Open Rate | Target CTR | Key Metric |
|-------|-----------------|------------|------------|
| 1 | 65%+ | 20%+ | Workbook consumption |
| 2 | 42%+ | N/A | Origin story + trust building |
| 3 | 38%+ | 3%+ | Case study engagement + reply rate |
| 4 | 35%+ | N/A | Full case study + aspiration building |
| 5 | 33%+ | 3%+ | Encouragement + reply rate |
| 6 | 30%+ | N/A | Mistake recognition + bridge to pitch |
| 7 | 35%+ | 10%+ | APPLICATION RATE |
| 8 | 30%+ | 8%+ | Objection handling |
| 9 | 35%+ | 8%+ | Final applications + "later" replies |

**Target:** 5-8% of Foundation buyers submit a coaching application.
**Note:** Lower conversion expected -- these buyers are earlier in their journey. Many will need 2-3 months with the workbook before they're ready. The "later" reply mechanism captures them for the next cohort.
**Price anchoring:** $5,997 for a 6-month system vs years of trial and error. Keisha's first wholesale deal ($8,500) paid for the program before she was halfway through.

## TONE NOTES FOR TRACK 3

- More encouraging, patient, supportive than Track 1 or Track 2
- Never condescending. Never "you should have started sooner."
- Acknowledge that starting from scratch takes courage
- Use Keisha as the primary case study (relatable: teacher, $52K, single mom, starting from zero)
- David referenced but secondary (he had more capital to deploy)
- The Foundation workbook positioned as Step 1, coaching as Step 2
- Always end with affirmation: "You've already done the hard part"
- Language: "walk beside you" not "teach you" -- partnership, not hierarchy
